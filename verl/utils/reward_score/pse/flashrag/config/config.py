...
class Config:
    def __init__(self, config_file_path=None, config_dict={}, is_components=False):
    ...
    def _set_additional_key(self):
        ...
        from verl.utils.reward_score.pse.flashrag.utils.constants import OPENAI_MODEL_DICT
    ...
    def _prepare_dir(self):
        ...
        self.final_config["save_dir"] = os.path.join(
            ...
            f"{current_time.strftime('%Y_%m_%d_%H_%M')}_{save_note}",
        )
