...
class PseScore(BaseMetric):
    ...
    def calculate_pse_score(self, pred_plan, gold_plan, pred_graph, gold_graph):
        ...
        return plan_scores['plan_score'].item(), step_score['step_score']
...
if __name__ == "__main__":
    ...
    plan_scores, step_score = pse_score.calculate_pse_score(print_info['predict_plan'], gold_plan,
