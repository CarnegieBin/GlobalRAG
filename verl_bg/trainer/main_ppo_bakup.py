...
def _select_rm_score_fn(data_source):
    if data_source in ['nq', 'triviaqa', 'popqa', 'hotpotqa', '2wikimultihopqa', 'musique', 'bamboogle', 'multi_hop_qa']:
...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            meta_data = data_item.non_tensor_batch['metadata']
...
def test_reward_func():
    """" test reward func """
    config = PSE_Config(config_dict={'e5_model_path': '/home/ssd3/wanfan01/Search-R1-main/e5'})
    # 初始化PSE评估器
    solution_str = """
...
<answer> Bob Kerr and Norm Hiscock </answer>
    ...
    reward = qa_em.compute_score_em(solution_str, ground_truth, meta_data, _evaluator)
    print(reward)
