...
import sys
import time
sys.path.append("/home/work/xiaxiaoling/debug_autoflow/baidu/infoflow-search/thoughtflow/autoflow/business/llms")

from reason_llm import ReasonModel
from langchain.prompts.base import StringPromptValue

ak = "1145f872c0425f4fca3001b4adac7d59"
sk = "86d70105891f3cffe30829771e5159b9"

url = "https://bep-gray.baidu-int.com/plugins/api/v2/access"

bot_id = 2850
# bot_id = 2243

model_name = ""
deepseek_v3 = ReasonModel(model_name=model_name, bot_id=bot_id, endpoint_url=url,
                   request_ak=ak, request_sk=sk,  max_token=10)

# # text = "q" * 13000
# text = "系统时间 2024-03-12 16:21:16 星期二, 请问下周五的三天后的日期是？"
def get_response_deepseek_v3(prompt):
    result = ""
    text = StringPromptValue(text=prompt)
    for data in deepseek_v3.stream(text):
        result += data
        print(data, end="")
    return result
...
class OpenaiGenerator:
    ...
    def get_response(self, input, **params):
        result = get_response_deepseek_v3(str(input))
        return result
